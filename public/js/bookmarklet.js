(function () {
    ...
    sty.appendChild(document.createTextNode(".rittmebox{z-index: 9999999999999999;position: absolute;top: 50%;left: 50%;margin-top: -135px;margin-left: -250px;background: #16A085;width: 400px;height: 170px;padding: 25px;border: #2c3e50 2em solid; border-radius: 20px;text-align:right} .rittmebox input[type='text']{width: 96%;height: 30px;border: 1px solid rgba(0,0,0,0.2);border-radius: 5px;margin: 5px 0;padding: 2%;font-size: 16px;color: #555;text-aligh:left;} .rittmebox label{display: inline;text-align: right;color: #fff;font-size: 16px;margin: 10px 0 0;} .rittmebox input[type='submit']{background: #2ecc71;box-shadow:0 2px 1px rgba(0, 0, 0, 0.3),0 1px 0 rgba(255, 255, 255, 0.4) inset;border: none;padding: 10px 15px;border-radius: 10px;color: #fff;font-weight: bold;margin: 5px;display: block;} .rittmebox #rittmebox_close {position: absolute;top: -13px;right: -16px;background: #16A085;border: none;padding: 5px 8px;font-family: verdana;font-weight: bold;color: #fff;border-radius: 20px;cursor:pointer} .rittmebox input[type='radio']{display:inline; height:16px;width:16px;}"));
